The regression tests can be run on your local machine by using the python scripts available in the SU2/TestCases/ directory and the mesh files from the su2code/TestCases repository. 
